            ...
            <div class="col-lg-8 col-lg-offset-2">
                ...
                <div class="panel panel-primary" id="hidepanel1">
                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal basic1" action="{{ url('admin/save_over_time') }}" method="post">
                            {{ csrf_field() }}

                            <div class="form-group">
                                <label class="col-md-3 control-label" for="product_type">اسم کارمند :</label>
                                <div class="col-md-9">
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label" for="over_time_money">مقدار :</label>
                                <div class="col-md-9">
                                    <input type="number" id="over_time_money" required name="over_time_money" type="text" placeholder="مقدار پول را به عدد وارد نمایید." class="form-control">
                                </div>
                            </div>
