            ...
            @endif
                ...
                <div class="panel panel-primary" id="hidepanel1">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal basic1" method="post" action="{{ route('admin.post_partner')  }}">
                        {{--CSRF Token--}}
                        {{ csrf_field() }}
                        <!-- Name input-->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input id="name" name="name" type="text" placeholder="وارد کنید" class="form-control" required></div>
                            </div>
