                    ...
                    <div class="panel-heading clearfix  ">
                        <div class="panel-title pull-left">
                            <div class="caption">
                                ...
                                راپور انتقال مواد خام
                            </div>
                        </div>
                    </div>
                    <div class="panel-body table-responsive">
                        <table class="table table-striped table-bordered" id="table1" width="100%">
                            @if( !$quantityMaterial->isEmpty() )
                                <div style="font-size:medium"><span style="font-weight: bold;"  id="company">مواد: </span> <span id="com_val">{{ $quantityMaterial[0]->raw_material_name }}</span></div>
                                <div style="font-size:medium"><span style="font-weight: bold;" id="responsible">نوعیت: </span> <span id="res_val">{{ $quantityMaterial[0]->raw_material_type }}</span></div>
                            @endif
                            <hr>
                            ...
                            <tbody>
                            <?php $i = 1 ?>
                            @foreach($quantityMaterial as $qua)
                                <tr>
                                    <td>{{ $i++ }}</td>
                                    <td>{{ $qua->date }}</td>
