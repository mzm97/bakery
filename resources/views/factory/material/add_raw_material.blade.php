            ...
            @endif
                ...
                <div class="panel panel-primary" id="hidepanel1">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal basic1" method="post" action="{{ route('admin.post_raw_material')  }}">
                        {{--CSRF Token--}}
                        {{ csrf_field() }}
                        <!-- Name input-->
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input id="raw_material_name" name="raw_material_name" type="text" placeholder="وارد نمایید" class="form-control" required></div>
                            </div>

                            <div class="form-group">
                                <label class="col-md-3 control-label" for="raw_material_type">نوع مواد:</label>
                                <div class="col-md-9">
                                    <input id="raw_material_type" name="raw_material_type" type="text" placeholder="نوع مواد را وارد کنید" class="form-control" required></div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input id="unit" name="unit" type="text" placeholder="واحد اندازه گیری را وارد کنید" class="form-control"></div>
                            </div>
