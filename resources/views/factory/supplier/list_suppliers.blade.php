                        ...
                        <table class="table table-striped table-bordered" id="table1" width="100%">
                            ...
                            @foreach($supplier as $sup)
                                <tr>
                                    ...
                                    <td>{{ $sup->more_info }}</td>
                                    <td>
                                        <a href="edit_supplier/{{ $sup->supplier_id }}"><i class="livicon" data-name="edit" data-size="18" data-c="#428bca" data-hc="#428bca" data-loop="true"></i></a>
                                        <a href="#" role="button" onclick="gettingId({{ $sup->supplier_id }})" class="confirm-delete" data-id="2" data-toggle="modal"><i class="livicon" data-name="remove-alt" data-size="18" data-c="#f56954" data-hc="#f56954" data-loop="true"></i></a>
                                        <a href="list_supplier_ledger/{{ $sup->supplier_id }}"><span>صورت حساب</span></a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
