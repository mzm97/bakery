...
@section('content')
    <section class="content-header">
        <!--section starts-->
        <h1>اضافه نمودن تهیه کنند گان</h1>
        <ol class="breadcrumb">
            <li>
            ...
            @endif
                ...
                <div class="panel panel-primary" id="hidepanel1">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" method="post" action="{{ route('admin.post_supplier')  }}">
                        {{--CSRF Token--}}
                        {{ csrf_field() }}
                        <!-- Name input-->
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input id="company" name="company" type="text" placeholder="اسم کمپنی را وارد کنید" class="form-control" required></div>
                            </div>

                            <div class="form-group">
                                <label class="col-md-3 control-label" for="responsible_person">شخص مسؤل:</label>
                                <div class="col-md-9">
                                    <input id="responsible_person" name="responsible_person" type="text" placeholder="اسم شخص مسؤل را وارد کنید" class="form-control" required></div>
                            </div>

                            <div class="form-group">
                                <label class="col-md-3 control-label" for="email">ایمیل آدرس:</label>
                                <div class="col-md-9">
                                    <input id="" name="email" type="text" placeholder="ایمیل آدرس را وارد کنید" class="form-control"></div>
                            </div>

                            <div class="form-group">
                                <label class="col-md-3 control-label" for="phone">شماره تماس:</label>
                                <div class="col-md-9">
                                    <input id="phone" name="phone" type="text" placeholder="شماره تماس را وارد کنید" class="form-control"></div>
                            </div>

                            <div class="form-group">
                                <label class="col-md-3 control-label" for="address">آدرس:</label>
                                <div class="col-md-9">
                                    <input id="address" name="address" type="text" placeholder="آدرس کمپنی را وارد کنید" class="form-control"></div>
                            </div>
