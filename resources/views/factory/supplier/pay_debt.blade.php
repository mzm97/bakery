            ...
            <!--basic form starts-->
                <div class="panel panel-primary" id="hidepanel1">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal basic1" method="post" action="{{ route('admin.post_pay_debt')  }}">
                        {{--CSRF Token--}}
                        {{ csrf_field() }}
                        <!-- Name input-->

                            <div class="form-group">
                                <label class="col-md-3 control-label" for="select21">تهیه کننده:</label>
                                <div class="col-md-9">
                                    <select id="select21" class="form-control select2" name="supplierId" onchange="showdebt(event)">
                                        <option value=""></option>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <input id="giving_money" name="giving_money" type="number" placeholder="مقدار پرداخت" class="form-control"></div>
                            </div>
...
@section('footer_scripts')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $("#giving_money").blur(function(){

                var val=parseInt($("#giving_money").val());
                var valR=parseInt($("#remainDebt").val());


                    if($("#giving_money").val().length === 0){
    ...
    <script type="text/javascript">
        function showdebt(event) {
            ...
            var Id=$("#select21").val();
            $.post("{{ route('admin.debtR') }}",{rawsupplierId:Id,_token:"{{ Session::token() }}"},function (data,status) {
                $("#remainDebt").empty();
