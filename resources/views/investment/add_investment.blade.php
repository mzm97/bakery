            ...
            <div class="row">
                ...
                <div class="col-lg-8 col-lg-offset-2">
                    ...
                    <div class="form-group basic1" >
                        <label class="col-md-3 control-label text-primary" style="font-size: 20px;">آمد پول از :</label>
                            &nbsp;&nbsp;&nbsp;
                    ...
                    <div class="panel-body">
                            ...
                            <div class="form-position">
                                <div class="col-md-12 text-right">
                                    <button type="submit" class="btn btn-responsive btn-primary btn-sm">آمد پول</button>
                                </div>
                            </div>
                        </form>
                    </div>
        ...
        <div class="row" id="nonbankDiv" style="display: none;">
            <div class="col-lg-8 col-lg-offset-2">
               ...
               امد پول از مرجع دیگر
                ...
                <form class="form-horizontal basic1" action="{{ url('admin/add_investment_record') }}" method="post">
                {{ csrf_field() }}
