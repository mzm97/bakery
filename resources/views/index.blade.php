...
@section('content')
    ...
    <section class="feature-main">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9 col-sm-9 col-xs-12 wow zoomIn right_float" data-wow-duration="2s">
    ...
    <div class="container">
        <div class="row">
            ...
            <!-- Accordions End -->
            <div class="col-md-6 col-sm-12 wow slideInLeft right_float" id="tab_content" data-wow-duration="1.5s">
            ...
            <div class="col-md-6 col-sm-12 wow slideInRight right_float" data-wow-duration="3s">
                <!-- Panel-group Start -->
        ...
        <div class="row text-center">
            ...
            <div class="col-md-3 col-sm-5 profile wow fadeInLeft right_float"  data-wow-duration="3s" data-wow-delay="0.5s">
            ...
            <div class="col-md-3 col-sm-5 profile wow fadeInUp right_float" data-wow-duration="3s" data-wow-delay="0.5s">
                <div class="thumbnail bg-white">
            ...
            <div class="col-md-3 col-sm-5 profile wow fadeInDown right_float" data-wow-duration="3s" data-wow-delay="0.5s">
                <div class="thumbnail bg-white">
            ...
            <div class="col-md-3 col-sm-5 profile wow fadeInRight right_float" data-wow-duration="3s" data-wow-delay="0.5s">
                <div class="thumbnail bg-white">
        ...
        <div class="row">
            <!-- What we are Start -->
            <div class="col-md-6 col-sm-6 wow zoomInLeft right_float box_read" data-wow-duration="3s">
                <div class="text-left">
                    <div>
            ...
            <!-- //What we are End -->
            <!-- About Us Start -->
            <div class="col-md-6 col-sm-6 wow zoomInRight box_read" data-wow-duration="3s">
                <div class="text-left">
                    <div>
        ...
        <div class="row">
            ...
            <div class="col-md-4 wow bounceInLeft right_float" data-wow-duration="3s">
                <div class="author">
            ...
            <div class="col-md-4 wow bounceIn right_float" data-wow-duration="3s">
                <div class="author">
            ...
            <div class="col-md-4 wow bounceInRight right_float" data-wow-duration="3s">
                <div class="author">
        ...
        <div class="row features">
            ...
            <div class="col-md-4 col-sm-4 wow fadeInUp right_float" data-wow-duration="3s" data-wow-delay="0.5s">
                <div>
                    <a href="#" class="right_float"><i class="livicon" data-name="checked-on" data-size="22" data-loop="true" data-c="#25a3d8" data-hc="#25a3d8"></i></a>
                ...
                <div>
                    <a href="#" class="right_float"> <i class="livicon" data-name="checked-on" data-size="22" data-loop="true" data-c="#ef8424 " data-hc="#ef8424 "></i>
                    </a>
                    <h4>Html 5</h4>
                    <p>
                        <label>"Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book."</label>
            ...
            <div class="col-md-4 col-sm-4 wow fadeInDown right_float" data-wow-duration="3s" data-wow-delay="0.5s">
                <div>
                    <a href="#" class="right_float"> <i class="livicon" data-name="checked-on" data-size="22" data-loop="true" data-c="#01bc8c" data-hc="#01bc8c"></i>
                    </a>
                    <h4>Unique Design</h4>
                    <p>
                        <label>"Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book."</label>
                ...
                <div>
                    <a href="#" class="right_float" > <i class="livicon" data-name="checked-on" data-size="22" data-loop="true" data-c="#1360b3 " data-hc="#1360b3 "></i>
                    </a>
                    <h4>Css</h4>
                    <p>
                        <label>"Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book."</label>
            ...
            <div class="col-md-4 col-sm-4 wow fadeInUp right_float" data-wow-duration="3s" data-wow-delay="0.5s">
                <div>
                    <a href="#" class="right_float"> <i class="livicon" data-name="checked-on" data-size="22" data-loop="true" data-c="#FFD43C" data-hc="#FFD43C"></i>
                    </a>
                    <h4>Clean Design</h4>
                    <p>
                        <label>"Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book."</label>
                ...
                <div>
                    <a href="#" class="right_float"> <i class="livicon" data-name="checked-on" data-size="22" data-loop="true" data-c="#91d659 " data-hc="#91d659 "></i>
                    </a>
                    <h4>Bootstrap</h4>
                    <p>
                        <label>"Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book."</label>
        ...
        <div class="sliders">
            ...
            <div class="container">
            <div class="row">
                <div class="col-md-3 col-sm-6 text-center wow zoomIn right_float" data-wow-duration="3.5s">
                ...
                <div class="col-md-3 col-sm-6 text-center wow zoomIn right_float" data-wow-duration="3s" data-wow-delay="0.8s">
                <div class="text-center center-block">
                ...
                <div class="col-md-3 col-sm-6 text-center wow zoomIn right_float" data-wow-duration="3s" data-wow-delay="1.2s">
                <div class="text-center center-block">
            ...
            <span>Lorem Ipsum is simply dummy text of the printing and typesetting industry</span>
                ...
                <div class="col-md-3 col-sm-6 text-center wow zoomIn right_float" data-wow-duration="3s" data-wow-delay="1.8s">
                <div class="text-center center-block">
